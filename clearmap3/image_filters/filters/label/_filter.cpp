...
static PyObject *__pyx_pf_9clearmap3_13image_filters_7filters_5label_7_filter__size_filter(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_img, int __pyx_v_minsize, int __pyx_v_maxsize, __Pyx_memviewslice __pyx_v_out, bool __pyx_v_return_labels); /* proto */
...
static PyObject *__pyx_pw_9clearmap3_13image_filters_7filters_5label_7_filter_1_size_filter(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("_size_filter (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_minsize)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("_size_filter", 0, 4, 5, 1); __PYX_ERR(0, 8, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_maxsize)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_size_filter", 0, 4, 5, 2); __PYX_ERR(0, 8, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_out)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_size_filter", 0, 4, 5, 3); __PYX_ERR(0, 8, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (kw_args > 0) {
    ...
    if (values[4]) {
      __pyx_v_return_labels = __Pyx_PyObject_IsTrue(values[4]); if (unlikely((__pyx_v_return_labels == ((bool)-1)) && PyErr_Occurred())) __PYX_ERR(0, 8, __pyx_L3_error)
    } else {
  ...
  __Pyx_RaiseArgtupleInvalid("_size_filter", 0, 4, 5, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 8, __pyx_L3_error)
  __pyx_L3_error:;
  ...
  __pyx_r = __pyx_pf_9clearmap3_13image_filters_7filters_5label_7_filter__size_filter(__pyx_self, __pyx_v_img, __pyx_v_minsize, __pyx_v_maxsize, __pyx_v_out, __pyx_v_return_labels);
...
static PyObject *__pyx_pf_9clearmap3_13image_filters_7filters_5label_7_filter__size_filter(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_img, int __pyx_v_minsize, int __pyx_v_maxsize, __Pyx_memviewslice __pyx_v_out, bool __pyx_v_return_labels) {
  int __pyx_v_zmax;
  int __pyx_v_ymax;
  int __pyx_v_xmax;
