...
For example to read image data use :func:`~clearmap3.io.IO.readData`:
    ...
    >>> import os
    >>> from bq3d import io
    >>> import bq3d.    >>> filename = os.path.join(bq3d.config.ClearMap_path,'Test/Data/Tif/test.tif')
...
For example to read point data use :func:`~clearmap3.io.IO.readPoints`:
    ...
    >>> import os
    >>> from bq3d import io
    >>> import bq3d.    >>> filename = os.path.join(bq3d.config.ClearMap_path, stack_processing')
...
and to write it use :func:`~clearmap3.io.IO.writePoints`:
    ...
    >>> import os, numpy
    >>> from bq3d import io
    >>> import bq3d.    >>> filename = os.path.join(bq3d.config.ClearMap_path, stack_stack_processing >>> points = numpy.random.rand(5,3)
