...
Images are represented internally as numpy arrays. bq3dassumes images
...
The bq3dtoolbox supports a range of (volumetric) image formats:

=============== ========================================================== ============================
Format          Descrition                                                 Module
=============== ========================================================== ============================
TIF             tif images and stacks                                      :mod:`~bq3d.IO.TIF`
RAW / MHD       raw image files with optional mhd header file              :mod:`~bq3d.IO.RAW`
NRRD            nearly raw raster data files                               :mod:`~bq3d.IO.NRRD`
IMS             imaris image file                                          :mod:`~bq3d.IO.Imaris`
reg exp         folder, file list or file pattern of a stack of 2d images  :mod:`~bq3d.IO.FileList`
=============== ========================================================== ============================

.. note:: bq3dcan read the image data from a Bitplane’s Imaris, but can’t export image data as an Imaris file.

The image format is inferred automatically from the file name extension.

For example to read image data use :func:`~bq3d.IO.IO.readData`:
...
To write image data use :func:`~bq3d.IO.IO.writeData`:
...
bq3dalso supports several data formats for storing arrays of points, such
...
bq3dsupports the following files formats for point like data:

========= ========================================================== =======================
Format    Description                                                Module
========= ========================================================== =======================
CSV       comma separated values in text file                        :mod:`~bq3d.IO.CSV`
NPY       numpy binary file                                          :mod:`~bq3d.IO.NPY`
VTK       vtk point data file                                        :mod:`~bq3d.IO.VTK`
========= ========================================================== =======================

.. note:: bq3dcan write points data to a pre-existing Bitplane’s Imaris file, but can’t import the points from them.


The point file format is inferred automatically from the file name extension.

For example to read point data use :func:`~bq3d.IO.IO.readPoints`:
...
and to write it use :func:`~bq3d.IO.IO.writePoints`:
